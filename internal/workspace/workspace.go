...
func (w *Workspace) Download(trackSlug, exerciseSlug string) (string, error) {
	...
	// Write linter overrides to silence stub noise (all tracks)
	w.writeLinterOverrides(trackSlug, filepath.Dir(dir))
...
// writeLinterOverrides writes linter config at the track root to silence
// noisy rules that fire on exercise stubs (unused vars, empty functions, etc.)
func (w *Workspace) writeLinterOverrides(trackSlug, trackRoot string) {
	overrides := linterOverrides[trackSlug]
...
// Per-track linter configs that silence exercise-stub noise.
var linterOverrides = map[string]map[string]string{
	"javascript": {
		"eslint.config.mjs": `// Auto-generated by coding-tui — silence stub noise
export default [
  {
    rules: {
      "no-unused-vars": "off",
...
`,
	...
	"python": {
		"setup.cfg": `# Auto-generated by coding-tui — silence stub noise
[flake8]
ignore = F841,W503,E501,F401
`,
		".pylintrc": `# Auto-generated by coding-tui — silence stub noise
[MESSAGES CONTROL]
disable=unused-variable,unused-argument,unused-import,missing-docstring,too-few-public-methods
`,
	},
	"rust": {
		".cargo/config.toml": `# Auto-generated by coding-tui — silence stub noise
[build]
rustflags = ["-A", "unused_variables", "-A", "dead_code", "-A", "unused_imports"]
`,
	},
	"ruby": {
		".rubocop.yml": `# Auto-generated by coding-tui — silence stub noise
AllCops:
...
`,
	...
	"go": {
		// Go doesn't compile with unused variables, but we can silence staticcheck
		"staticcheck.conf": `# Auto-generated by coding-tui — silence stub noise
checks = ["all", "-U1000"]
`,
	},
}
